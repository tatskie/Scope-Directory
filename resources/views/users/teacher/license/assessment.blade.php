...
<div class="subpage">
  ...
  <div class="subpage-inner">
    ...
    <div class="l-container">
      <div class="form-wrap">
        <p><strong>Classifications</strong> (Level 3 is the highest.)</p>
        <br>
        <table width="100%">
          <tbody>
            <tr>
      ...
      <div class="form-wrap">
          ...
          @if(auth()->user()->answerScore->is_done_tif == true)
            <form class="proceed-form-prevent-multiple-submits" method="POST" action="{{ route('teacher.proceed')}}" enctype="multipart/form-data">
            @csrf
          ...
          <form class="pif-form-prevent-multiple-submits" method="GET" action="{{ route('teacher.tif', $tif->url)}}" enctype="multipart/form-data">
          @csrf
