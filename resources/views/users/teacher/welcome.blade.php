...
<div class="subpage">
  ...
  <div class="subpage-title">
    <div class="subpage-title-inner">
      <h1>Welcome to Your Professional Teacher Designation.</h1>
    </div>
  </div>
  ...
  <div class="subpage-inner">
    ...
    <div class="subpage-content">
      ...
      @endif
      At the end of the survey you will have attained one of the 3 designations depending upon the input you
      ...
      <div class="btn btn-gradient-link btn-mv" style="height: 50%;">
        <form class="form-prevent-multiple-submits" method="POST" action="{{ route('teacher.score') }}">
