    ...
    <div class="l-container">
          ...
          <tbody>
            ...
            <tr>
              ...
              <tr>
                ...
                <td width="136">TESOL UG 1</td>
              </tr>

              <tr>
                <td width="96">Level 2</td>
                <td width="136">TESOL UG 2</td>
              </tr>

              <tr>
                <td width="96">Level 3</td>
                <td width="136">TESOL UG 3</td>
              </tr>
      ...
      <div class="form-wrap">
          ...
          @if(auth()->user()->answerScore->is_done_tif == true)
            <form class="proceed-form-prevent-multiple-submits" method="POST" action="{{ route('undergrad.proceed')}}" enctype="multipart/form-data">
            @csrf
          ...
          <form class="pif-form-prevent-multiple-submits" method="POST" action="{{ route('sif.proceed')}}" enctype="multipart/form-data">
          @csrf
            <input type="hidden" name="proceed_pif" value="1">
            <p>The next set of questions relate to any  volunteer / community work you have undertaken" - Student Impact Factor Questions</p>
            <br>
            <button type="submit" class="btn btn-gradient btn-register button-prevent-multiple-submits">
              <span class="btn-text">
                <i class="pif-spinner fa fa-spinner fa-spin" style="display: none;"></i>
                {{ __('Take SIF Questions') }}
              </span>
            </button>
          </form>
          <br>
