    ...
    >
      <template slot="body">
        ...
        <div class="form" v-else>
          <form class="form-horizontal" @submit.prevent="createPublication" @keydown="form.errors.clear($event.target.name)" enctype="multipart/form-data">
          <div class="form-item">
          ...
          <div class="form-item">
            ...
            <div class="form-input">
              <input
                ...
                name="source"
                value=""
                placeholder="Ex. Seige, Springer, Academics Education, OUP."
                id="source"
              />
            </div>
            <div class="form-error">
  ...
  import Modal from '../../common/Modal'
    ...
    export default {
      ...
      methods: {
        ...
        createPublication() {
          this.form.post('/api/academia/publications')
            .then(()=>{
              location.reload();
              Toast.fire({
                  type: 'success',
