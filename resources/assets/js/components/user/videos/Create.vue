    ...
    >
      <template slot="body">
        ...
        <div class="form" v-else>
          <form class="form-horizontal" @submit.prevent="createVideo" @keydown="form.errors.clear($event.target.name)" enctype="multipart/form-data">
  ...
  import Modal from '../../common/Modal'
    ...
    export default {
      ...
      methods: {
        ...
        createVideo() {
          this.form.post('/api/academia/videos')
            .then(()=>{
              location.reload();
              Toast.fire({
                  type: 'success',
