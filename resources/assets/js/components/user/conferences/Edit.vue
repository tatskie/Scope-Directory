    ...
    >
      <template slot="body">
        ...
        <div class="form" v-else>
          <form class="form-horizontal" @submit.prevent="updateConference" @keydown="form.errors.clear($event.target.name)" enctype="multipart/form-data">
          <div class="form-item">
  ...
  import Modal from '../../common/Modal'
    ...
    export default {
      ...
      methods: {
        ...
        updateConference() {
          this.form.put('/api/academia/conferences/'+this.form.id)
            .then(()=>{
              location.reload();
              Toast.fire({
                  type: 'success',
