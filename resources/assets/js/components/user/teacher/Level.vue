...
<script>
    import Question from '../teacher/questions/Question';
	import RequestDelete from '../teacher/license/RequestDelete'
    import OrderLicence from '../teacher/license/OrderLicence'
