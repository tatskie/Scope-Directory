      ...
      methods: {
        loadProfile() {
            axios.get('/api/teacher/profile').then(({data}) => (
              this.user = data,
              this.category = data.card.license_category,
              this.tif = data.card.tif,
        ...
        loadShippingAddress() {
            axios.get('/api/teacher/shipping-address').then(({data}) => (
              this.shipping = data
              ));
        },
        ...
        myBilling() {
          ...
          this.$router.push('/teacher/billing/').catch(err => {});
        },  
        ...
        createShippingAddress() {
          this.shippingForm.post('/api/teacher/shipping-address')
            .then(()=>{
              Toast.fire({
                  type: 'success',
