<template>
  <div class="product">
    <div class="btn-update -withlabel" @click="modalTrigger()">
      Edit Public Profile&nbsp;<i class="fa fa-user-circle" style="font-size:16px;color:#fff"></i>
    </div>
    <modal
    ...
    >
      <template slot="body">
        ...
        <div class="form" v-else>
          <form class="form-horizontal" @submit.prevent="editProfile" @keydown="form.errors.clear($event.target.name)" enctype="multipart/form-data">
          <div class="form-item">
          ...
          <div class="form-item" v-show="!form.is_present">
    ...
    export default {
      ...
      methods: {
        modalTrigger() {
          this.loading = true;
          this.showModal = true;
          this.form.fill(this.information);
          this.loading = false;
        },
        ...
        editProfile() {
          this.form.put('/api/academia/informations/'+ this.form.id)
            .then(()=>{

              Toast.fire({
                  type: 'success',
                  title: 'Public Updated Successfully!'
              });
