<template>
  <div class="product">
    <div class="btn-create -withlabel" style="margin-left:20px" @click="modalTrigger">
      ...
      <span>Create Special Awards</span>
    </div>
    <modal
      :title="'Create Special Awards'"
    ...
    >
      <template slot="body">
        ...
        <div class="form" v-else>
          <form class="form-horizontal" @submit.prevent="createSpecialAwards" @keydown="form.errors.clear($event.target.name)" enctype="multipart/form-data">
  ...
  import Modal from '../../common/Modal'
    ...
    export default {
      ...
      methods: {
        ...
        createSpecialAwards() {
          this.form.post('/api/academia/awards')
            .then(()=>{
              location.reload();
              Toast.fire({
                  type: 'success',
                  title: 'Special Awards Created Successfully!'
              });
