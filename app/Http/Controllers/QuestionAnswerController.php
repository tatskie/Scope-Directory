...
class QuestionAnswerController extends Controller
{
    ...
    public function proceed(Request $request)
    {
        ...
        return redirect()->to('/license-card'); // redirect license form
    }
    ...
    public function followupQuestion(Request $request, $id)
    {
        ...
        return redirect()->route('question.show', $lastQuestion->url)->with(['question', 'pages']);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($hasAnswer)
        {
            ...
            return redirect()->route('questions.show', $nextQuestion->url); // return if user has answer
        }
