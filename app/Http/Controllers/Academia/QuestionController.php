...
class QuestionController extends Controller
{
    ...
    public function show(Question $question, QuestionService $service)
    {
        ...
        if($hasAnswer)
        {
            ...
            if ($nextQuestion) {
                return redirect()->route('academia.question', $nextQuestion->url); // return if user has answer
            }
        }
        ...
        return view('academia.questions.show', compact(['question', 'pages', 'questions', 'lastQuestion', 'number']));
    }
    ...
    public function followupQuestion(FollowupQuestion $followupQuestion)
    {
        ...
        return view('academia.questions.followup', compact(['followupQuestion', 'pages', 'questions', 'lastQuestion', 'number']));
    }
}
