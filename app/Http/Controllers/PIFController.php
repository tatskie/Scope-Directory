...
class PIFController extends Controller
{
    ...
    public function pifQuestion(Request $request)
    {
        ...
        return redirect()->route('tif.show', $question->url);
    }
    ...
    public function show(Question $question)
    {
        ...
        if($hasAnswer)
        {
            foreach ($question->followupQuestion as $followupQuestion) {
                ...
                if (!$hasFollowupAnswer) {
                    return redirect()->route('tif.followup', $followupQuestion->url);
                }
            }
        ...
        return view('tif.show', compact(['question', 'pages', 'questions', 'lastQuestion', 'number']));
    }
    ...
    public function followupQuestion(FollowupQuestion $followupQuestion)
    {
        ...
        return view('tif.followup', compact(['followupQuestion', 'pages', 'questions', 'lastQuestion', 'number']));
    }
