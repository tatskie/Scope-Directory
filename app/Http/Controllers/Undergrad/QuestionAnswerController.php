...
class QuestionAnswerController extends Controller
{
    ...
    public function followupQuestion(Request $request, $id)
    {
        ...
        if($hasFollowupAnswer)
        {
            foreach ($question->followupQuestion as $followup) {
                ...
                if ($hasFollowupAnswer) {
                    return redirect()->route('undergrad.followup', $followup->url);
                }
            }
        }
        ...
        if(!$lastQuestion)
        {
            ...
            return redirect()->to('/undergrad-assessment'); // If no more Questions Redirect to assessment page
        }
        
        return redirect()->route('undergrad.question', $lastQuestion->url)->with(['question', 'pages']);
    }
    ...
    public function store(Request $request)
    {
        ...
        if($hasAnswer)
        {
            ...
            return redirect()->route('undergrad.questions', $nextQuestion->url); // return if user has answer
        }
        ...
        if(!$lastQuestion)
        {
            ...
            return redirect()->to('/undergrad-assessment'); // If no more Questions Redirect to License Card
        }
